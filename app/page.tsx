...
export default function Home() {
  return (
    <section className="flex flex-col items-center justify-center text-dark w-full mx-auto min-h-screen bg-[url('.././public/images/background-light.jpg')] bg-center bg-no-repeat bg-cover">
      {/* <h1 className="pt-0 pb-5 text-5xl font-bold">
          HEY, I'M OBALOLUWA OLUSOJI
        </h1> */}
      <div className="">
        <AnimatedText text="HEY, I'M OBALOLUWA OLUSOJI" className="text-6xl" />
      </div>
